...
<head>
    ...
    if (cssUrls != null) {
    	String[] cus = cssUrls.split(";");
    	for (String cu : cus) {
    		%>
    		<link type="text/css" rel="stylesheet" href="<%= cu %>" />
    		<%
    	}
    } else {
    %>
    ...
    String jsUrls = System.getProperty("jsUrls");
    if (jsUrls != null) {
    	String[] jus = jsUrls.split(";");
    	for (String ju : jus) {
            %>
            <script type="text/javascript" src="<%= ju %>"></script>
            <%    		
    	}
    } else {
    %>
